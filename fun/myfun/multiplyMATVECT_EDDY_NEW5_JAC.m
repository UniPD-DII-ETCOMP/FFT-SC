%% System MVM with vector: Eddy Currents Problem Jacobian
% time-dependent
%**************************************************************************
%%This function computes MVM of system matrix and a vector
%System matrix is:
%                       [1/tau*L+ theta*(H+R)   theta*Aee']
%                       [theta*Aee                     0  ]
...
%**************************************************************************
function [sol] = multiplyMATVECT_EDDY_NEW5_JAC(JIn0,theta,tau,...
                                        fN,z_realx_loc,z_realy_loc,...
                                        z_realz_loc,Hjac,...
                                        idxFx,idxFy,idxFz,d,AeeR,L,M,N)
...
%%2.*************************** Add Hjac*j + A'*phi ***************************
sol(1:num_curr) = sol(1:num_curr) + theta*Hjac*JIn0(1:num_curr) + ...
    theta*(AeeR.'*JIn0(num_curr+1:end)) ;

%%3.*************************** Perform A*j ***************************
sol(num_curr+1:end) = theta*AeeR*JIn0(1:num_curr);
